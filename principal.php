...
?>
     ...
     <div id="content">
        <h2><u>Consultes dinàmiques</u></h2>
        ...
        <h2><u>Consultes estàtiques</u></h2>
        ...
        <form action='insertar.php' method='post'><!--php  per inserir    -->
            ...
            <small>(Si estas en Mozilla Firefox o Internet Explorer siusplau proveu aquest apartat en un altre navegador, el input data no esta habilitat en aquests navegadors.)</small>
            </div>
        </form>
